...
public class ImageViewEx extends AppCompatImageView {
    ...
    public ImageViewEx(Context context, AttributeSet attrs, int defStyle) {
        ...
        mBorderWidth = a.getDimensionPixelSize(R.styleable.ImageViewEx_border_width, DEFAULT_BORDER_WIDTH);
        mBorderColor = a.getColor(R.styleable.ImageViewEx_border_color, DEFAULT_BORDER_COLOR);
